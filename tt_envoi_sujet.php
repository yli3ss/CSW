...
if ($titre_sujet === "" || $resume === "") {
    ...
    header("Location: sujets_ping.php");
}
...
$stmt = $mysqli->prepare(
    "INSERT INTO `sujets` (nom, resume, deux_equipes, confidentiel) VALUES (?, ?, ?, ?)"
);
if (!$stmt) {
...
$stmt->bind_param("ssii", $titre_sujet, $resume, $deux_equipes, $confidentiel);
...
if (!$pstmt) {
    ...
    header("Location: sujets_ping.php"); exit;
}
